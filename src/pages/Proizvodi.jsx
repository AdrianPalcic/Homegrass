  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Otkrijte HomeGrass proizvode – umjetne trave vrhunske gustoće i izgleda, idealne za vaš vrt, terasu ili igralište."
        />
        <meta
          name="keywords"
          content="umjetna trava, HomeGrass, proizvodi, vrtna trava, terasa, igra, gustoća, kvaliteta"
        />
        <meta
          property="og:title"
          content="HomeGrass Proizvodi – Umjetna Trava"
        />
        <meta
          property="og:description"
          content="Pregledajte ponudu HomeGrass proizvoda i pronađite idealnu umjetnu travu za vaš prostor."
        />
