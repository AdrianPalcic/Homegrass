  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Pogledajte kako smo riješili izazove za klijenta u ${lokacija}. ${opis}`}
        />
        <meta
          name="keywords"
          content={`umjetna trava, projekt ${title}, HomeGrass, ${lokacija}, rješenje, umjetni travnjak, terasa, vrt`}
        />

        <meta property="og:title" content={`${title} | HomeGrass`} />
        <meta
          property="og:description"
          content={`Primjena HomeGrass trave u stvarnim uvjetima - ${opis}`}
        />
        ...
        <meta
          ...
          content={`Rješenje za klijenta u ${lokacija} - ${opis}`}
        />
      ...
      {prije && poslije && <BeforeAndAfter prije={prije} poslije={poslije} />}
      {review && (
        <Testimonial
          text={review}
          name={klijent}
