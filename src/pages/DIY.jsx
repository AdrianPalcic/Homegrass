  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Postavite umjetnu travu sami uz naš detaljan korak-po-korak vodič. HomeGrass vam donosi jednostavno i povoljno rješenje za vlastitu zelenu oazu."
        />
        <meta
          name="keywords"
          content="DIY umjetna trava, vodič za postavljanje trave, kako postaviti umjetnu travu, HomeGrass ugradnja"
        />
        <meta
          property="og:title"
          content="DIY Vodič za Umjetnu Travu | HomeGrass"
        />
        <meta
          property="og:description"
          content="Naučite kako postaviti umjetnu travu sami pomoću HomeGrass DIY vodiča – uštedite novac i ostvarite zelenu površinu iz snova."
        />
