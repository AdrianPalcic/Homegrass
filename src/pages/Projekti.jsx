...
const Projekti = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          HomeGrass Projekti | Umjetna trava primjeri u stvarnom svijetu
        </title>
        <meta
          name="description"
          content="Pogledajte uspješne projekte HomeGrass umjetne trave u vrtovima, terasama i igralištima diljem Hrvatske. Inspirirajte se za svoj sljedeći projekt!"
        />
        <meta
          name="keywords"
          content="HomeGrass, umjetna trava, vrt, terasa, igralište, projekti, instalacija, inspiracija, krajobrazno uređenje"
        />
        <meta property="og:title" content="HomeGrass Projekti" />
        <meta
          property="og:description"
          content="Inspiracija iz stvarnog svijeta – pogledajte gdje je postavljena HomeGrass umjetna trava."
        />
