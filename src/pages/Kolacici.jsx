...
const Kolacici = () => {
    return (
        <div className="cookie-policy-page">
            <Helmet>
                <title>Politika kolačića | HomeGrass - Upravljanje kolačićima za umjetne travnjake</title>
                <meta name="description" content="HomeGrass koristi kolačiće za poboljšanje iskustva kupnje umjetne trave. Saznajte kako upravljati postavkama kolačića za naš katalog travnjaka." />
                ...
                {/* <meta property="og:url" content="https://homegrass.hr/politika-kolacica" />
                <link rel="canonical" href="https://homegrass.hr/politika-kolacica" /> */}
            </Helmet>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>Spremanje proračuna za <strong>umjetni travnjak</strong></li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>Praćenje koje vrste <strong>umjetne trave</strong> najviše zanimaju posjetitelje</li>
                            <li>Poboljšanje izgleda stranice s katalogom</li>
                            <li>Mjerimo učinkovitost kampanja za <strong>umjetne travnjake</strong></li>
                        </ul>
                        <p className="note">(Google Analytics implementacija aktivirat će se nakon vaše privole)</p>
                    </li>
                    <li>
                        <strong>Marketinški kolačići</strong> - Koriste se za:
                        <ul>
                            <li>Prikaz relevantnih oglasa za <strong>umjetne travnjake</strong></li>
                            <li>Retargeting kampanje (ako ste pregledali određenu vrstu <strong>umjetne trave</strong>)</li>
                        </ul>
                    </li>
                </ul>

                <h2>Kontakt za pitanja o kolačićima</h2>
                <p>Za sva pitanja o kolačićima u vezi s kupnjom <strong>umjetne trave</strong>, kontaktirajte našeg službenika za zaštitu podataka:</p>
                <address>
                    <p> <a href="mailto:info@homegrass.hr">info@homegrass.hr</a></p>
