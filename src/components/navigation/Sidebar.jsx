    ...
    <>
      <div className={`sidebar ${isOpen ? "open" : ""}`}>
        ...
        <nav className="sidebar-links">
          <Link to="/onama" onClick={onClose}>
            O nama
          </Link>
          <Link to="/proizvodi" onClick={onClose}>
            Naši Proizvodi
          </Link>
          <Link to="/projekti" onClick={onClose}>
            Naši Projekti
          </Link>
          <Link to="/vodic" onClick={onClose}>
            DIY - vodič
          </Link>
